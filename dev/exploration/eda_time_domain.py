...
eda_time_domain.py
==================
Time-domain EDA: representative waveforms ordered by κ, per-feature scatter
vs κ, and Hilbert envelope plots.

Usage
-----
    python dev/exploration/eda_time_domain.py
    python dev/exploration/eda_time_domain.py --config alt.yaml
"""
...
WAVEFORM_MS = 20.0
ENV_SHOW_MS = 20.0
BP_LOW_HZ   = None   # set e.g. 10e3 to enable bandpass stats, or None to skip
BP_HIGH_HZ  = None
...
# %%
# =============================================================================
# Representative waveforms (N examples spread by κ)
# =============================================================================

_save(
    _eda.plot_waveforms(sweeps, SENSORS, waveform_ms=WAVEFORM_MS),
    "eda_representative_waveforms.png",
)

# %%
# =============================================================================
# Per-feature scatter vs κ
# =============================================================================

_save(_eda.plot_time_domain_stats(stats_df, SENSORS), "eda_time_domain_stats.png")

if hp_df is not None:
    _save(
        _eda.plot_time_domain_stats(hp_df, SENSORS, bp=True, bp_label=BP_LABEL),
...
_save(_eda.plot_envelope(sweeps, SENSORS, kappa_ivs, iv_colors), "eda_envelope.png")
...
if __name__ == "__main__":
    ...
    print("eda_time_domain complete.")
