...
\label{fig:waveforms}
\end{figure}\todo{Select new files. The first file shows weird waveforms for both AE and US (clipping). Maybe same y-axis?}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/eda_spectrogram_chronological.png}
\caption{Spectrograms of the raw AE and US ordered chronologically by acquisition time. PSD is calculated with Welch's method, Hann windows, 50\% overlap, and segment lengths of 4096 samples and 65536 samples, respectively.}
